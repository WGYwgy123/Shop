                ...
                <div class="modal-body">
                    <form class="form-horizontal" id="updatePsw-form" name="update-form" method="post">
                        ...
                        <div class="form-group" style="display: none" id="newPswError">
                            <label for="name" class="col-sm-2 control-label"></label>
                            <div class="col-sm-9">
                                <label style="color: #BD1F3B">密码由数字和字母组成，且长度要在6-16位之间</label>
                            </div>
                        </div>
                        <div class="form-group" style="display: none" id="newPswError2">
                            <label for="name" class="col-sm-2 control-label"></label>
                            <div class="col-sm-9">
                                <label style="color: #BD1F3B">新密码不能与旧密码相同</label>
                            </div>
                        </div>
                ...
                <div class="demo-charts mdl-color--white mdl-shadow--2dp mdl-cell mdl-cell--12-col mdl-grid">
                    <div class="tab-content">
                        <table class="table" cellpadding="6" cellspacing="1">
                            ...
                            <tbody >
                            <tr >
                                <th style="border: 0px solid transparent" class="tl">用户编号</th>
