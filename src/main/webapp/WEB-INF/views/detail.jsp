        ...
        $(document).ready(function () {
            ...
            $(function () {
                ...
                $('.tabs a').click(function () {
                    ...
                    $(panel).show();
                    return fasle; //告诉浏览器  不要返回这个链接
                });

                $(".tabs li:first a").click(); //web 浏览器，单击第一个标签
            });
                    ...
                    $.ajax({
                        ...
                        success(response){
                            if(response.errorCode === "100"){
                                alert("添加成功");
                                window.location = "/shop/showcart";
                            }else if(response.objectMap.msg === "请先登录"){
                    ...
                    <div class="elav_info">
                        ...
                        <div class="rel-div">
                            ...
                            <form class="cart-btn-area new_meta" action="${pageContext.request.contextPath}/addCart" method="post">
                                <input type="hidden" value="${goodsInfo['goods'].goodsid}" name="goodsid" id="goodsid"/>
                                <input type="number" value="1" name="goodsnum">
                                <button class="add-tocart cart_zpf" type="submit" id="addCart_btn">加入购物车</button>
                            </form>
                            <div class="add_defi new_meta">
